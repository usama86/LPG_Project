			...
			<ul className="navbar-nav ml-auto">
				...
				<li className="nav-item">
					<Link to="/register-restaurant">
						<button type="button" className="btn btn-warning btn-sm text-uppercase mr-2 mr-1 px-3">
							Register Restaurant
						</button>
					</Link>
				</li>
		...
		return (
			...
			<nav className="navbar navbar-expand-lg navbar-dark pt-3">
				...
				<Link className="navbar-brand" to={homeIconLink}>
					<img alt="Quick Food Logo" style={{ width: '166px' }} src={require('../assets/images/logo1.png')} />
				</Link>
