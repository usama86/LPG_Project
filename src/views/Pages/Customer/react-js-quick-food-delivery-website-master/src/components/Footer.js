            ...
            <div className="container-fluid pt-5 bg-footer">
                <div className="container mb-4">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            <div className="footer-head-div">
                                <h5 className="text-white">Popular Distributor</h5>
                            </div>
                            <div className="footer-list-div">
                                <ul>
                                    <li><a href="#">Ali Distributor</a></li>
                                    <li><a href="#">Jamshed Distributor</a></li>
                                    <li><a href="#">Rafey Distributor</a></li>
                                    <li><a href="#">Usama Distributor</a></li>
                                    <li><a href="#">Saad Distributor</a></li>
                                    <li><a href="#">Amaan Distributor</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <ul>
                                    <li className="pb-3">
                                        <span className="bg-warning p-2 rounded mr-3">
                                           <FaPhone icon="phone" className="text-white" />
                                        </span>
                                        <span>+92 321 828 6662</span>
                                    </li>
                                    <li className="pb-3">
                                        <span className="bg-warning p-2 rounded mr-3">
                                              <FaEnvelope icon="envelope" className="text-white" />
                                        </span>
                                        <span>info@smartgas.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
